...
class DomRecenzija extends Model
{
    use HasFactory;

    protected $table = 'dom_recenzije';
    ...
    protected static function boot()
    {
        ...
        // Update dom rating when review is approved/disapproved
        ...
        // Update dom rating when review is deleted
