...
class StoreDomRequest extends FormRequest
{
    ...
    {
        return $this->user()->hasRole(['admin', 'care_home_manager']);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:domovi_njega,slug|regex:/^[a-z0-9-]+$/',
    ...
    protected function prepareForValidation(): void
    {
        ...
        $booleanFields = [
            ...
            'controlled_entry', 'video_surveillance', 'online_upit'
        ];
