...
class StoreBanjaRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->hasRole(['admin', 'spa_manager']);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:banje,slug|regex:/^[a-z0-9-]+$/',
    ...
    protected function prepareForValidation(): void
    {
        ...
        $booleanFields = [
            ...
            'online_rezervacija', 'online_upit'
        ];
